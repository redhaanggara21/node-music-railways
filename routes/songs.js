...
const redis = require("../config/redis-connection.config");
const isCached = require("../config/redisIsCache.config");
const router = require("express").Router();

router.get("/getAll", isCached, async (req, res) => {
...
router.post("/save", async (req, res) => {
  ...
  try {
    ...
    // redis.set('savesong', savedSong);

    // const value =  client.get('savesong');
